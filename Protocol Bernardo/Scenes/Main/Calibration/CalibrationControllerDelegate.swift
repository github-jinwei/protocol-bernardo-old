...
protocol CalibrationControllerDelegate: AnyObject {
    ...
    func calibration(_: CalibrationController, physicalDeviceStateChanged: DeviceState)
    ...
    func calibration(_: CalibrationController, referenceDeviceStateChanged: DeviceState)
    ...
    func calibration(_: CalibrationController, liveDeltasUpdated: CalibrationDeltas?)
    ...
    func calibration(_: CalibrationController, storedDeltasChanged: CalibrationDeltas)
}
