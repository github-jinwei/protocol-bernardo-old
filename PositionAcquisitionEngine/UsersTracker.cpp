...
float3 UsersTracker::P3FtoFloat3(const nite::Point3f &p3f) {
#ifdef __APPLE__
	return simd_make_float3(p3f.x, p3f.y, p3f.z);
#else
	return float3(p3f.x, p3f.y, p3f.z);
#endif
}

quatf UsersTracker::niteQuaternionToCQuaternion(const nite::Quaternion &quaternion) {
#ifdef __APPLE__
