...
/// Used by a layoutView element to propagate its events and access properties of its
/// parent layoutView
protocol LayoutCanvasElementDelegate: AnyObject {
    ...
    /// Asks the delegate for the layoutView root node
    ///
    /// - Returns: The layoutView root node
    func canvasRootNode() -> SKNode

    /// Asks the delegate for the layoutView window
    ///
    /// - Returns: The layoutView contaner window
